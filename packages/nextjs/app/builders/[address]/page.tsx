...
const BuilderPage = () => {
    ...
    // Function to get ENS name from address (you might want to implement ENS resolution)
    // ENS name resolution using wagmi
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    {builderInfo.skills.slice(0, 2).map((skill, index) => (
                                        <div key={index} className="text-base-content/70">{skill}</div>
                                    ))}
                                </div>
                            </div>
                    ...
                    <section id="achievements" className="scroll-mt-20">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {builderInfo.achievements.map((achievement, index) => (
                                <div key={index} className="flex items-start space-x-4 p-6 bg-base-200/50 rounded-2xl border border-base-300">
